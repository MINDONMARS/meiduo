...
SECRET_KEY = '(tgy9txfalaceje*ken81lkb+uscsn6()$d6-r$7^%7&96o0bj'
...
CACHES = {
    ...
    "history": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.73.129:6379/3",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    "cart": {
            "BACKEND": "django_redis.cache.RedisCache",
            "LOCATION": "redis://192.168.73.129:6379/4",
            "OPTIONS": {
                "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.73.129:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
